...
for index in Desired_subhalos:
    ...
    try: 
        ...
        Ratios.append(ratio) # Append the ratio of stars asociated with the disk
...
Write2File(Ratios,Sigmas,BH_Masses,Coords,Star_Masses,pos,grad,fname='Brahma_Data/Kin_Decomp_TNG_z0')
